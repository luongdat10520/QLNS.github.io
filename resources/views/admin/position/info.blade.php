...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary text-center">Thông tin chức vụ</h6>
    </div>
    <div class="card-body">
        <form>
            @csrf
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" value="{{$position->position_name}}" disabled>
            </div>
            <div class="mb-3">
                <label for="address" class="form-label">Lương cơ bản:</label>
                <input type="text" class="form-control" value="{{$position->base_salary}}" disabled>
            </div>
        </form>
